...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/38fe3d38ef68caf8d57bf.jpg')).split()
BOT_START_TIME = time()
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://telegra.ph/file/d687192acafa8a19e443c.mp4")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{Script.py.CUSTOM_FILE_CAPTION}")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", f"{Script.py.IMDB_TEMPLATE_TXT}")
